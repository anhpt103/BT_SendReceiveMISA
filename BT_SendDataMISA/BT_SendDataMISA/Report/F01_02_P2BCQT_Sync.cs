        ...
        private string GetDataReport(out List<F01_02_P2BCQTModel> oListF01_02_P2BCQT)
        {
            ...
            if (listStartEndDateOYear.Count > 0)
            {
                foreach (var eachMonth in listStartEndDateOYear)
                {
                    ...
                    string msg = Exec.ThirdOutputResult("Proc_FIR_GetF01_02_BCQT_P2_ToX1", new { pStartDate, pFromDate, pToDate, ListBudgetSourceID, BudgetChapterCode, ListBudgetKindItemCode, EnumMethodDistributeID, ProjectID, IsSummaryBudgetSource, IsSummaryBudgetChapter, IsSummaryBudgetKindItem, IsSummaryMethodDistribute, IsSummaryProject }, out ReportHeader outItem, out List<F01_02_P2BCQTDetailItem> oList, out List<F01_02_P2BCQTProjectItem> oListProject);
